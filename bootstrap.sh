...
if [[ "$OSTYPE" == "linux-gnu" ]]; then
	...
	sudo apt install zsh git clang clang-format tmux ccls bat ripgrep black fzf make cmake npm python3-venv python3-pip cpplint cmake-format exuberant-ctags
